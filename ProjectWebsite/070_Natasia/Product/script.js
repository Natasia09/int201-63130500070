...
//product1ctor
//ชื่อ
const divProductEle = document.createElement('div'); //สร้างelement
 divProductEle.setAttribute('class',product1.id);//ทำเป็นคลาส
...
const button3 = document.createElement("button"); 
    ...
    pProductStockEle3.appendChild(button3);
    pProductStockEle3.appendChild(document.createElement('br'));
    pProductStockEle3.appendChild(document.createElement('br'));
...
const button4 = document.createElement("button"); 
   ...
   pProductStockEle4.appendChild(button4); 
   pProductStockEle4.appendChild(document.createElement('br'));
   pProductStockEle4.appendChild(document.createElement('br'));
...
const button5 = document.createElement("button"); 
   ...
   button5.textContent = "Buy Now"; 
   pProductStockEle5.appendChild(button5); 
   pProductStockEle5.appendChild(document.createElement('br'));
   pProductStockEle5.appendChild(document.createElement('br'));
